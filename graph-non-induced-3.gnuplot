...
set output "gen-graph-non-induced-3.tex"
...
set label 1 at screen 0.5, screen -0.08 center '\small $G(30, x) \rightarrowtail G(150, y)$'

set title "Recursive Calls"
set cbtics 2 add ('${\le}10^{2}$' 2) add ('${\ge}10^{8}$' 8)
plot "ps30-ts150.non-induced.average-nodes.plot" u ($2/50):($1/50):(log10($3+1)) matrix w image notitle
